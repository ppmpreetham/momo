...
First off, thank you for considering contributing to `Momo`. This guide details all the general information that one should know before contributing to the project.
...
```
git clone https://github.com/ppmpreetham/momo.git
```
...
```
git remote add upstream https://github.com/ppmpreetham/momo.git
```
...
**1.** On GitHub, navigate to the main page of the repository. [Here](https://github.com/ppmpreetham/momo.git) in this case.
